...
const Projects = ({ projects }: Props) => {
  // console.log(urlFor(projects[0]?.image).url());
  return (
    <motion.div
      initial={{ opacity: 0 }}
        ...
        {projects.map((project, i) => (
          ...
          >
            <motion.img
              ...
              className="md:mb-0 flex-shrink-0 w-56 h-56 rounded-full md:rounded-lg md:w-64 md:h-96 xl:w-[500px] xl:h-[300px] object-contain "
            />
